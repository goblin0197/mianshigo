...
import com.goblin.mianshigo.constant.RedisConstant;
import com.goblin.mianshigo.exception.BusinessException;
import com.goblin.mianshigo.mapper.UserMapper;
import com.goblin.mianshigo.model.dto.user.UserQueryRequest;
import com.goblin.mianshigo.model.entity.User;
import com.goblin.mianshigo.model.enums.UserRoleEnum;
import com.goblin.mianshigo.model.vo.LoginUserVO;
import com.goblin.mianshigo.model.vo.UserVO;
import com.goblin.mianshigo.saToken.DeviceUtils;
...
import static com.goblin.mianshigo.constant.UserConstant.USER_LOGIN_STATE;
...
//        RBitSet signInBitSet = redissonClient.getBitSet(key);
//        // linkedHashMap 保证顺序不变
//        Map<LocalDate, Boolean> signInRecordMap = new LinkedHashMap<>();
//        // 获取今年至今的总天数
//        int totalDay = Year.of(year).length();
//        for (int i = 1; i <= totalDay; i++) {
//            // 获取第i天的日期
//            LocalDate currentDate = LocalDate.ofYearDay(year, i);
//            // 获取第i天的签到情况
//            boolean hasSign = signInBitSet.get(i);
//            signInRecordMap.put(currentDate, hasSign);
//        }
